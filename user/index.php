  ...
  <div class="content-wrapper" style="min-height: 822px;">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="small-box bg-info" style="background: url('image/<?= $row['image'] ?>') center center;">

            <div class="inner"> 
              <h3><?= $row['title'] ?></h3>
            </div>
        
            <a href="detailblog.php?id_blog=<?= $row['id_blog'] ?>" class="small-box-footer">Read More<i class="fas fa-arrow-circle-right"></i></a>
        </div>
        <?php endforeach ?>
        <!-- /tampil blog -->
