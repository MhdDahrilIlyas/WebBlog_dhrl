        ...
        <!-- bagian input data -->
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambahkan Blog</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <!-- <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id_blog" name="id_blog" placeholder="ID_Blog">
                  </div> -->
                  <div class="form-group">
                  ...
                  <div class="form-group" >
                    ...
                    <textarea id="editor" class="form-control" name="body" id="body" rows=""></textarea>
                  </div>
                </div>
              ...
              <?php 
                if(isset($_POST['btn_simpan'])){
                  ...
                  $query    = "INSERT INTO blog VALUES ('', '$title', '$gambar', '$body', '$idUser')";
                  $res      = mysqli_query($conn, $query);

                  if($res){
                    echo "
                    <script>
                        alert('Blog ditambahkan');
                    </script>";
                  }else{
                    echo "
                    <script>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel Blog/Artikel</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>Body</th>
                      <th>ID User</th>
                      <th colspas="2">Aksi</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php $data = tampilBlog(); foreach($data as $row): 
                    ?>
                      <tr>
                        ...
                        <td>
                          <a href="edit-blog.php?&id_blog=<?= $row['id_blog'] ?>">
                          <button type="button" class="btn btn-block btn-info btn-xs">Edit</button>

                          <a href="hapus-blog.php?&id_blog=<?= $row['id_blog'] ?>">
